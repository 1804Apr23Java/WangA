...
/**
 * Servlet implementation class MgrResolvedReqServlet
 */
public class MgrResolvedReqServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MgrResolvedReqServlet() {
        super();
